...
// 建設里程碑進度更新功能
function initMilestoneProgressSystem() {
...
// 確保在 DOM 載入後執行，或在 CMS 環境中立即執行
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initMilestoneProgressSystem);
} else {
    // DOM 已經載入完成，立即執行
    initMilestoneProgressSystem();
}
